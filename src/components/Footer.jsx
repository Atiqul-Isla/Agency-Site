  ...
  return (
    <div className='max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300'>
      <div>
        ...
        <p className='py-4'>Nivaly works wih its team of contractors in Toronto to deliver results for our clients, We primarily work with medium to small-size businesses.</p>
